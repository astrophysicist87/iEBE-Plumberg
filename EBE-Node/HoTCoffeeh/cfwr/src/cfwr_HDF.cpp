...
{
//	#pragma omp critical(resonance_HDF_admin)
//	{
		// administration_mode:
		//	0 - Initialize
...
{
//	#pragma omp critical(target_HDF_admin)
//	{
		// administration_mode:
		//	0 - Initialize
		//	1 - Open (already initialized)
...
{
//	#pragma omp critical(resonance_HDF_access)
//	{
		// access_mode:
		//	0 - set array chunk
		//	1 - get array chunk
...
{
//	#pragma omp critical(target_HDF_access)
//	{
		// access_mode:
		//	0 - set array chunk
		//	1 - get array chunk
...
{
//	#pragma omp critical(copy_HDF_chunk)
//	{
		const int chunk_size = n_pT_pts * n_pphi_pts * n_pY_pts * qxnpts * qynpts * ntrig;
...
{
//	#pragma omp critical(bessel_HDF_admin)
//	{
		// administration_mode:
		//	0 - Initialize
		//	1 - Open (already initialized)
...
{
	//#pragma omp critical(bessel_HDF_access)
	{
		// access_mode:
		//	0 - set array chunk
		//	1 - get array chunk
