...
#do
	...
	do
		...
		nice -n 0 time bash ./HoTCoffeeh.sh false true CF_npphi=48 CF_npT=15 CF_npY=21 chosenParticlesMode=0 CF_resonanceThreshold=`echo $rf` qtnpts=13 qxnpts=7 qynpts=7 qznpts=7 &> ./results/all.out
