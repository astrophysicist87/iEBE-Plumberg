...
for axis in X
do
	for npt0 in 15 21 31
	do
		for nqt0 in 23 25 27 29 31
		do
			mkdir $homeDirectory/AXIS_`echo $axis`_pT`echo $npt0`_qt`echo $nqt0`
			for resfrac in 0.20
			do
				mkdir $homeDirectory/AXIS_`echo $axis`_pT`echo $npt0`_qt`echo $nqt0`/RESFRAC_`echo $resfrac`
			done
		done
	done
done
...
do
	...
	do
		...
		do
			...
			for resfrac in 0.20
			do
				lwd=$homeDirectory/AXIS_`echo $axis`_pT`echo $npt0`_qt`echo $nqt0`/RESFRAC_`echo $resfrac`
				mkdir $lwd/results
